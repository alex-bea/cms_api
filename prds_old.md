...
| I want to… | Go to |
| --- | --- |
| Review scope, goals, and governance | §1–§3 |
| Check storage layout & retention | §4 |
| Understand freshness, cost, and legal guardrails | §6–§8 |
| Reference schema/validation patterns | §10 |
| Examine templates, roadmap, and metrics | §25, §14–§15 |

> **Callout — Phase 2 Traceability:** Update `docs/release_notes/phase2_refactor.md` whenever scraper governance, manifests, or schema contracts change; this standard is the source of truth for automation expectations.
...
> **Callout — Contract Drift Blocker:** Treat schema or layout changes detected here as merge blockers. Update the schema registry and PRDs (plus `docs/release_notes/phase2_refactor.md`) before approving new runs.
...
> **Callout — Drift Alert Response:** When alerts flag schema/contract drift, pause ingestion, capture the manifest snapshot, update DatasetSpecs + schemas, and document the remediation in `docs/release_notes/phase2_refactor.md` before re-running.
