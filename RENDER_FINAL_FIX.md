# Final Fix for Render - Fix Permissions First

**Step 1: Fix permissions on contracts directory**

```bash
sudo chmod -R 777 /app/cms_pricing/ingestion/contracts/
```

**Step 2: Now run ingestion**
...
**OR: If you don't have sudo access, try this workaround:**
